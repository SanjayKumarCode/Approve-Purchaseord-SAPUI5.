		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Approve Purchaseord",
									"targetURL": "#comexampleapprovepurchaseord-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comexampleapprovepurchaseord-display": {
								"semanticObject": "comexampleapprovepurchaseord",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.example.approvepurchaseord",
									"url": sap.ui.require.toUrl("com/example/approvepurchaseord")
								}
							}
						}
					}
